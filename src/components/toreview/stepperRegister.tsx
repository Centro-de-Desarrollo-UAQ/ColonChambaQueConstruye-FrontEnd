        ...
        <div>
          ...
          <div className="my-6 text-sm text-gray-600">
            <p>
              ...
              de Privacidad de la Bolsa de Trabajo UAQ. Estos términos regulan el uso de la
              plataforma para gestionar tu perfil, aplicar a ofertas de empleo y contactar con
              empresas interesadas en tu perfil profesional.
            </p>
          </div>
        </div>
      ),
        ...
        <div>
          ...
          <div className="space-y-4 py-6">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <Label htmlFor="vacancy" className="mb-3">
                  Modalidad de empleo preferente
                </Label>
                <CustomSelect
