    ...
    <div className="bg-zinc-50 pt-20 pb-10">
      <div className="mx-auto max-w-screen-xl">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="p-4">
            <h3 className="text-uaq-default-800 mb-4 text-lg font-bold">Institucional</h3>
            <p className="mt-8">
          ...
          {/* Columna 3: Empresas */}
          <div className="p-4">
            <h3 className="text-uaq-default-800 mb-4 text-lg font-bold">Empresas</h3>
            <p className="mt-8">
          ...
          <div className="p-4">
            <h3 className="text-uaq-default-800 mb-4 text-lg font-bold">Candidatos</h3>
            <p className="mt-8">
