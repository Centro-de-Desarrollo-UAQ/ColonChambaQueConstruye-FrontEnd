...
export default function CompanyCard({
  ...
  return (
    <div className="border-zinc-300 hover:border-uaq-brand-800 group w-[800px] cursor-pointer rounded-lg border shadow-sm transition-all duration-300 hover:translate-y-[-2px] hover:shadow-md">
