          ...
          <DrawerContent className="overflow-y-auto overflow-x-hidden">
            <DrawerHeader className='px-10 items-start'>
              ...
              <div className="flex flex-row items-center w-full">
                <div className="w-[100px] flex-shrink-0 rounded-full p-4">
                    <Avatar className="h-18 w-18 object-contain">
                        <AvatarImage src={logoUrl ?? undefined} alt={company} />
                        <AvatarFallback className="bg-uaq-terniary text-white text-2xl font-semibold">
                        {initials}
                ...
                <div className="flex flex-col self-center px-4 py-4 items-end text-end">
                  <div className="text-base">{"Hace "+daysSince(job.createdAt ?? "2025-09-23")+" dias" /* Tiempo desde la publicación */}</div>
                </div>
              </div>
