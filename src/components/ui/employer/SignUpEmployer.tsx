  ...
  return (
    <FormProvider {...methods}>
      <form
        ...
        className="bg-zinc-50 p-8 rounded-lg shadow-xl w-2xl"
      >
        <h2 className="text-3xl font-bold mb-8 text-center">
          Únete como empleador
        </h2>
        <p className="text-center mb-6 leading-5">
          Conecta con el talento que tu empresa necesita. Publica ofertas de
          trabajo y encuentra a los profesionales ideales para tu equipo.
        </p>
        {/* UI paso a paso */}
        {step === 1 && (
          <>
