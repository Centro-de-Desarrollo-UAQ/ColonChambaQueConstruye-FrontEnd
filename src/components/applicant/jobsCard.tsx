...
import { Balloon, Buildings, Calendar, ClockCircle, Dollar, Gps, MapPoint, User } from '@solar-icons/react';
  ...
  return (
    <div className="hover:border-uaq-brand-800 group flex flex-col w-8/12 rounded-lg border border-zinc-300 shadow-sm transition-all duration-300 hover:translate-y-[-2px] hover:shadow-md">
      ...
      <div className="flex flex-row items-center">
        ...
        <div className="flex flex-1 flex-col self-center px-4 py-4 transition-colors duration-300">
          <div className="flex-1 space-y-1 text-start">
            <div className="text-lg font-[800]">{job.title }</div>
            <div className="text-l">{job.company}</div>
          </div>
        </div>
        ...
        <div className="flex w-[250px] flex-col justify-center gap-2 self-center rounded-r-lg p-4 transition-colors duration-300">
          <div className="flex items-center gap-2 text-sm text-gray-700 transition-colors duration-200 group-hover:text-gray-900">
            ...
            <span className="whitespace-nowrap">{job.schedule}</span>
          </div>
          <div className="flex items-center gap-2 text-sm text-gray-700 transition-colors duration-200 group-hover:text-gray-900">
      ...
      <div className="flex flex-col px-2">
        ...
        <div className="flex flex-1 flex-col self-center px-4 py-4 transition-colors duration-300">
          <div className="flex-1 space-y-1 text-start">
            <div className="text-start font-[400] text-gray-600">{job.description}</div>
          </div>
        </div>
      </div>

      <div className="flex flex-row px-5 mb-5">
        <div className="flex items-center gap-2 text-l font-[600] text-blue-700 transition-colors duration-200 group-hover:text-blue-900 mx-3">
        ...
        <div className="flex flex-1 flex-col self-center px-4 py-4 transition-colors duration-300 items-end">
          <DrawerTrigger className="text-start font-[400] text-gray-600 group-hover:text-gray-800 hover:text-uaq-brand active:text-uaq-brand-hover cursor-pointer hover:bg-gray-50 active:bg-gray-100 p-3 rounded-2xl flex items-center gap-2 text-l transition-colors duration-200 mx-3">
        ...
        <DrawerHeader className='px-10 items-start'>
          ...
          <div className="flex w-[250px] flex-col gap-2 rounded-r-lg py-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="whitespace-nowrap">{job.modality}</span>
            </div>
            <div className="flex items-center gap-2">
