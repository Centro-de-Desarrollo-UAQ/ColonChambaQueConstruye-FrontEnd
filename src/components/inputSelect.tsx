    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center space-x-2 w-full">
        <div className="flex flex-col min-w-[120px]">
          ...
          />
          <Label htmlFor="description" variant="description" className="mt-1">Description</Label>
        </div>
      ...
      <div className="flex items-center space-x-2 w-full">
          <div className="flex items-center w-full gap-2">
            <div className="flex-1">
              ...
              <Label htmlFor="min-age" variant="description" className="mt-1">Descripcion</Label>
            </div>
      ...
      <div className="flex items-center space-x-2 w-full"> 
        <div className="flex flex-col min-w-[120px]">
          ...
          />
          <Label htmlFor="country" variant="description" className="mt-1">Descripción</Label>
